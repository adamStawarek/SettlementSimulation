...
namespace SettlementSimulation.Engine.Tests.Unit
{
    public class SimulationEngineTests
    {
        ...
        public void Setup()
        {
            var fields = new[]
            {
                new Field(0,0){DistanceToWater = 20},
                new Field(1,0){DistanceToWater = 20},
                new Field(2,0){DistanceToWater = 20},
                new Field(3,0){DistanceToWater = 20},

                new Field(0,1){DistanceToWater = 30},
                new Field(1,1){DistanceToWater = 30},
                new Field(2,1){DistanceToWater = 30},
                new Field(3,1){DistanceToWater = 30},

                new Field(0,2){DistanceToWater = 40},
                new Field(1,2){DistanceToWater = 40},
                new Field(2,2){DistanceToWater = 40},
                new Field(3,2){DistanceToWater = 40},

                new Field(0,3){DistanceToWater = 50},
                new Field(1,3){DistanceToWater = 50},
                new Field(2,3){DistanceToWater = 50},
                new Field(3,3){DistanceToWater = 50},

                new Field(0,4){DistanceToWater = 60},
                new Field(1,4){DistanceToWater = 60},
                new Field(2,4){DistanceToWater = 20},
                new Field(3,4){DistanceToWater = 20}
            };
